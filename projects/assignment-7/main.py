...
def generate_qr_code(data, path, fill_color='green', back_color='white'):
...
def main():
    ...
    parser.add_argument('--url', help='The URL to encode in the QR code', default='https://github.com/PavanRahul7/Assignment7')
